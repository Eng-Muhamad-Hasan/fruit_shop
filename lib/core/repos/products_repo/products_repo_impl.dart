...
class ProductsRepoImpl implements ProductsRepo{
 ...
 try{
  final data = await databaseService.getData(path: BackendEndpoints.getProducts,documentId: null, query:{
...
try{
  final data = await databaseService.getData(path: BackendEndpoints.getProducts) as List<Map<String, dynamic>>;
  List<ProductEntity> products = data.map((e) => ProductModel.fromJson(e).toEntity()).toList();
  return right(products);
